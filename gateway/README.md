...
This directory contains the MCP (Model Context Protocol) gateway management tools for Argus.
...
- The gateway must be running before starting Argus investigations
...
Once the gateway is set up and running, it provides the MCP endpoint that the Argus core system connects to for accessing infrastructure APIs and tools.