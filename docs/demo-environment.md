...
The Argus includes a demo environment that simulates infrastructure operations. This allows you to explore the system's capabilities without connecting to production systems.
...
The demo environment includes several pre-configured scenarios that showcase the Argus's capabilities:
